...
const capsuleAmbientTexture = textureLoader.load('/Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_ambientOcclusion.png');
const capsuleBaseTexture = textureLoader.load('Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_basecolor.png');
const capsuleHeightTexture = textureLoader.load('Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_height.png');
const capsuleMetallicTexture = textureLoader.load('Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_metallic.png');
const capsuleNormalTexture = textureLoader.load('Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_normal.png');
const capsuleRoughnessTexture = textureLoader.load('Sci-fi_Metal_Mesh_002_SD/Sci-fi_Metal_Mesh_002_roughness.png');
